...
const html = fs.readFileSync("clients/conifer/site/index.html", "utf8");
...
fs.mkdirSync("clients/conifer/redesign-v2/partials", { recursive: true });
fs.writeFileSync("clients/conifer/redesign-v2/partials/delta-diagram.html", out);
